...
* [tranquility](https://github.com/druid-io/tranquility) ⭐ 520 | 🐛 103 | 🌐 Scala | 📅 2020-01-13
...
* [druid-spark-batch](https://github.com/metamx/druid-spark-batch) ⭐ 102 | 🐛 21 | 🌐 Scala | 📅 2021-10-21
* [node-druid-query](https://github.com/7eggs/node-druid-query) ⭐ 94 | 🐛 17 | 🌐 JavaScript | 📅 2024-07-11
* [embedded-druid](https://github.com/eBay/embedded-druid) ⚠️ Archived
* [druid-client](https://github.com/implydata/druid-client) ⭐ 33 | 🐛 4 | 🌐 Java | 📅 2018-01-04
* [clj-druid](https://github.com/y42/clj-druid) ⭐ 31 | 🐛 7 | 🌐 Clojure | 📅 2019-12-16
* [kafka-spark-streaming-druid](https://github.com/ramkumarvenkat/kafka-spark-streaming-druid) ⭐ 30 | 🐛 3 | 🌐 Scala | 📅 2023-09-29
* [druid-mdx](https://github.com/julianhyde/druid-mdx) ⭐ 26 | 🐛 1 | 🌐 Java | 📅 2016-08-03 Example of running MDX on Druid via Mondrian and Calcite
* [druid-console](https://github.com/druid-io/druid-console) ⭐ 20 | 🐛 20 | 🌐 CoffeeScript | 📅 2022-12-07
* [druid-scala-client](https://github.com/daggerrz/druid-scala-client) ⭐ 16 | 🐛 1 | 🌐 Scala | 📅 2017-01-12
* [yahoo-druid-extensions](https://github.com/yahoo/druid-extensions) ⚠️ Archived
* [druid-hadoop-utils](https://github.com/himanshug/druid-hadoop-utils) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2017-01-18
* [druid-hadoop-inputformat](https://github.com/implydata/druid-hadoop-inputformat) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2016-10-26
* [druidlet](https://github.com/InferlyticsOSS/druidlet) ⭐ 9 | 🐛 1 | 🌐 Java | 📅 2016-05-24
* [incubator-zeppelin-druid](https://github.com/lorthos/incubator-zeppelin-druid)

## Deployment

* [docker-druid](https://github.com/druid-io/docker-druid) ⭐ 194 | 🐛 36 | 📅 2019-10-08
* [druid-kubernetes](https://github.com/krallistic/druid-kubernetes) ⭐ 35 | 🐛 0 | 🌐 Smarty | 📅 2016-12-02
* [cm-druid](https://github.com/knoguchi/cm-druid) ⭐ 31 | 🐛 9 | 🌐 Python | 📅 2019-09-03
* [druid-ansible](https://github.com/imungoma/druid-ansible) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2015-06-29
* [druid-puppet](https://github.com/MrAlias/druid) ⭐ 4 | 🐛 0 | 🌐 Puppet | 📅 2015-12-12 Puppet module that sets up and configures a full druid cluster
* [druid-rpm](https://github.com/cleberar/druid-rpm) ⭐ 3 | 🐛 1 | 🌐 Makefile | 📅 2016-01-15

## Monitoring

* [druid-monitor](https://github.com/shrekwang/druid-monitor) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2014-01-02
* [druid-metrics-to-kafka](https://github.com/quantiply/druid-metrics-to-kafka) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2015-09-07

## UI

* [metabase](https://github.com/metabase/metabase) ⭐ 48,747 | 🐛 4,301 | 🌐 Clojure | 📅 2026-08-13
...
* [RDruid](https://github.com/druid-io/RDruid) ⭐ 52 | 🐛 5 | 🌐 R | 📅 2016-04-18 - An R connector for Druid

### JavaScript

* [plywood](https://github.com/implydata/plywood) ⭐ 382 | 🐛 54 | 🌐 JavaScript | 📅 2024-11-20 - A higher level API for Druid. An extension of the work that was started in facet.js.
* [node-druid-query](https://github.com/7eggs/node-druid-query) ⭐ 94 | 🐛 17 | 🌐 JavaScript | 📅 2024-07-11 - A Node.js client for Druid

### Clojure

* [clj-druid](https://github.com/y42/clj-druid) ⭐ 31 | 🐛 7 | 🌐 Clojure | 📅 2019-12-16 - A Clojure client for Druid
...
* [druid-php](https://github.com/pixelfederation/druid-php) ⚠️ Archived - A PHP client for Druid
* [PHP-Druid](https://github.com/Neeke/PHP-Druid) ⭐ 7 | 🐛 0 | 🌐 C | 📅 2018-05-02 - A Druid driver for PHP with PECL extension

### Scala

* [scruid](https://github.com/ing-bank/scruid) ⭐ 118 | 🐛 8 | 🌐 Scala | 📅 2021-07-04 - A Scala client for Druid

### Java

* [druidry](https://github.com/zapr-oss/druidry) ⭐ 195 | 🐛 44 | 🌐 Java | 📅 2023-08-06 - A Java Client and query generator for Druid

### Go

* [godruid](https://github.com/shunfei/godruid) ⭐ 70 | 🐛 1 | 🌐 Go | 📅 2023-08-25
...
* [Saiku](https://github.com/OSBI/saiku) ⭐ 1,313 | 🐛 56 | 🌐 Java | 📅 2026-08-13
